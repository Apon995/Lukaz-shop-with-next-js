        ...
        <div className="group relative bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-700 ease-out cursor-pointer overflow-visible">
          ...
          <div className="relative h-48 sm:h-56 md:h-64 flex items-center justify-center pt-2 pb-8 overflow-visible">
            <div className="relative">
              ...
              {/* Background Image - Shows by default, blurs on hover */}
              <Image width={100} height={100}
                ...
                className="w-74 h-54 sm:w-80 sm:h-56 md:w-96 md:h-64 object-contain transform transition-all duration-700 ease-out
                        ...
                        group-hover:blur-md group-hover:scale-95 group-hover:opacity-60"
                style={{
              ...
              {/* No Background Image - Hidden by default, animated on hover */}
              <Image width={100} height={100}
                  src="/shoe.png"
                alt="Premium Sneaker"
                className="absolute inset-0 w-74 h-54 sm:w-80 sm:h-56 md:w-96 md:h-64 object-contain transform transition-all duration-700 ease-out
                        ...
                        group-hover:opacity-100 group-hover:scale-115 group-hover:-translate-y-24 group-hover:rotate-2
              ...
              <div className="absolute inset-0 w-56 h-40 sm:w-64 sm:h-44 md:w-72 md:h-48 bg-gradient-to-b from-transparent via-transparent to-black opacity-15 
                            ...
                            group-hover:scale-80 group-hover:opacity-25 group-hover:translate-y-6 z-5"></div>
            </div>
          </div>
